...
public class DashboardController {
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('bank:stats:read')")
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('system:stats:read')")
