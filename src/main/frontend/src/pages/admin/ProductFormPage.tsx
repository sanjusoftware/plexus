        ...
        <div className="px-12 py-10 bg-blue-900 text-white flex justify-between items-center relative overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-4xl font-black tracking-tighter uppercase">
              {isEditing ? 'Update Product Aggregate' : 'New Product Definition'}
            </h2>
          ...
          <button onClick={() => navigate('/products')} className="hover:bg-blue-800 p-3 rounded-full transition relative border border-white/10 shadow-lg">
            <X className="w-8 h-8" />
          </button>
        </div>
