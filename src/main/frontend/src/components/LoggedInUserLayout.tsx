...
import {
  Cpu, LayoutDashboard, Building2, Package, LogOut, User as UserIcon, List, Database, Bookmark, Puzzle, CircleDollarSign, Layers, ChevronLeft, ChevronRight, ShieldCheck, ExternalLink, Library
} from 'lucide-react';
